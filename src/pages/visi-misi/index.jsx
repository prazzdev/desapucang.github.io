    ...
    return (
        <MainLayout title="Visi Misi">
            <Section title="Visi dan Misi">
                <h1 className="font-inter-bold font-lg mt-2 mb-1">VISI</h1>
                <p className="font-inter-reg">"BANJARNEGARA BERMARTABAT DAN SEJAHTERA"</p>
                <h1 className="font-inter-bold font-lg mt-2 mb-1">MISI</h1>
                <ul className="list-decimal pl-5 font-inter-reg">
